...
import { getOrderDetailsById } from "@/services/order";
...
export default function OrderDetailsPage() {
    const {
        ...
        orderDetails, setOrderDetails, user
    ...
    useEffect(() => {
        async function extractOrderDetails() {
            // Implementation to fetch order details by ID
            setPageLevelLoader(true);

            const res = await getOrderDetailsById(params['order-details']);
        ...
        if (params['order-details']) {
            extractOrderDetails();
        }
    }, [params, setPageLevelLoader, setOrderDetails]);
        ...
        <div className="py-14 px-4 md-px-6">
            ...
            <div className="mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0">
                <div className="flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8">
                    ...
                    <div className="flex justify-center flex-col md:flex-row items-stretch md:items-center w-full space-y-4 md:space-y-0 md:space-x-5 xl:space-x-8">
                        <div className="flex flex-col px-4 py-6 md:p-6 xl:p-8 w-full bg-gray-50 space-y-6">
                            <h3 className="text-xl font-semibold leading-6 text-gray-900">Summary</h3>
                            <div className="flex justify-center items-center w-full space-y-4 flex-col border-gray-200 border-b pb-4">
                                <div className="flex justify-between w-full">
                                    <p className="text-base leading-5 text-gray-800">Sub total</p>
                ...
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex justify-between xl:h-full items-stretch w-full flex-col mt-6 md:mt-0">
                        <div className="flex justify-center md:justify-start xl:flex-col flex-col md:space-x-6 lg:space-x-8 xl:space-x-0 space-y-4 ms:space-y-0 xl:space-y-12 md:flex-row items-center md:items-start">
