...
export default function CommonDetails({ item }) {
    ...
    const { componentLevelLoader, setComponentLevelLoader, user, setShowCartModal } = useContext(GlobalContext);


    async function handleAddToCart(getItem) {
        // console.log("Add to cart", getItem);
                    ...
                    <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
                        ...
                        <div className="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0">
                            ...
                            <button
                                ...
                                className="mt-1.5 inline-block bg-black px-5 py-3 text-xs font-medium tracking-wide uppercase text-white cursor-pointer"
                            >
                                {
